			...
			<div class="wrapper" id="amazingcaption">
				...
				<h4 class="getpro"><a href="http://codecanyon.net/item/image-hover-effects-wordpress-plugin/12386610?ref=labibahmed" target="_blank">Get Pro Now to Get More Amazing Options</a></h4>
				<hr>
